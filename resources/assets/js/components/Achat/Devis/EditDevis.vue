...
<div v-if="!loading">
     <div class="row">
        <div class="col">
        <router-link class="btn btn-primary mb-3 retour  float-right " :to="'/getDevisA'"> <i class="fas fa-long-arrow-alt-left fontsize"></i> </router-link>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <div class="container  infoClient">
            <label for="">{{devi.nom_societe_comp}} </label>
            <div class="form-group row">
            <div class="col-sm-10">
 ...
 updateDevis: function(){
     ...
     console.log(this.devi.date_limit_d)
        ...
        axios.post('/updateDevis',{devis:this.devi,commandes:this.commandes,modePaiements:this.modePaiement,suppCommandes: this.suppCommandes}).then( response => {             
                    this.$router.push('/getDevisA/edit');  
