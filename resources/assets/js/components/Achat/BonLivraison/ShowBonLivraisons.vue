...
<div v-if="!loading">
    ...
    <h3>Liste des Bons de réception</h3>
    <hr>   
    </div>
          ...
          getBonLivraisons(){
             ...
             deleteBonLivraison:function(bonLivraison){
                ...
                redirect_To_ShowBonLivraison(reference_bl){
                     this.$router.push('/ShowBonLivraisonA/'+reference_bl);
            },
            redirect_To_EditBonLivraison(boncommande){
                   //  this.$router.push('/ShowBonLivraison/'+reference_bl);
                     this.$router.push({ name: 'EditBonLivraisonA', params: { reference_bl: boncommande.reference_bl, fk_compte_bl: boncommande.fk_compte_bl}});
