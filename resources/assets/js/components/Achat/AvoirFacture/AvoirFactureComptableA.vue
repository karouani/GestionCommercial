...
import  Pagination from '../../Pagination.vue';
   ...
   if(this.$route.params.success == "edit"){
           ...
           created () {
             ...
             this.$router.push('/AvoirFactureComptableA');
        }
        ...
        this.$router.push({ name: 'addAvoirFactureA', params: { id_compte:  this.compte.id_compte ,reference_af: this.avoirFacture.reference_af ,currentDate: this.currentDate }});
            ...
            redirect_To_EditAvoirFacture(avoirFacture){
                   //  this.$router.push('/ShowBonCommande/'+reference_bc);
                     this.$router.push({ name: 'EditAvoirFactureA', params: {id_af: avoirFacture.id_af, reference_af: avoirFacture.reference_af, fk_compte_af: avoirFacture.fk_compte_af}});

            },
               redirect_To_AvoirFactureDetails(avoirFacture){
                    this.$router.push({ name: 'AvoirFactureDetailsA', params: {id_af: avoirFacture.id_af, reference_af: avoirFacture.reference_af}});
