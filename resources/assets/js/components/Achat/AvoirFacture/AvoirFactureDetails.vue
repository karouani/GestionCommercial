...
<div v-if="!loading">
  ...
  <strong>Status Bien Modifier !</strong>
     ...
     <div class="row">
        <div class="col">
        <a href="#"  v-if="profile.role !='Expert Comptable'"  @click="redirect_To_AddAvoirFacture(avoirFacture)"  class="btn btn-secondary mb-3  float-right" ><i class="fas fa-exchange-alt"></i> Convertir </a>
        ...
        <router-link v-if="profile.role !='Expert Comptable'" class="btn btn-primary mb-3 retour float-right " :to="'/getAvoirFacturesA'">
        <i class="fas fa-long-arrow-alt-left fontsize"></i>
        </router-link>
        
        <router-link v-if="profile.role =='Expert Comptable'" class="btn btn-primary mb-3 retour float-right " :to="'/AvoirFactureComptableA'">
        <i class="fas fa-long-arrow-alt-left fontsize"></i>
        </router-link>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <div class="container  infoClient">
            <label class="" for=""> <b>{{avoirFacture.nom_compte}}</b> </label>
...
updateStatusAvoirFacture(){
                ...
                .then(response => {
                    ...
                    this.$router.push({ name: 'getAvoirFacturesA', params: { success: "editStatusuccess"  }});
              
                       /* this.$router.push('/AvoirFactureDetailsA/editS/'+this.avoirFacture.id_af);
    ...
    getStatu(){
       ...
       redirect_To_AddAvoirFacture(avoirFacture){
                   //  this.$router.push('/ShowBonCommande/'+reference_bc);
                     this.$router.push({ name: 'addBonCommandeA', params: {id_af: avoirFacture.id_af, reference_af: avoirFacture.reference_af}});
