...
getBonLivraisonsCompte(id_compte){
 axios.get('/getBonLivraisonsCompte/'+id_compte)
        .then((response) => {
                  console.log("getBonLivraisonsCompte")
            console.log(response.data.bonLivraisons)
                this.facture=response.data.bonLivraisons;
    ...
    getClient(id_compte){
        ...
        axios.get('/getClient/'+id_compte)
            .then((response) => {
                    ...
                    this.getBonLivraisonsCompte(id_compte)
...
//alert(daysDiff)
   ...
   /*    if(this.$route.params.id_bl != null){
      ...
      // replace `getPost` with your data fetching util / API wrapper
            ...
            this.getClients();
            this.getBonLivraisons();
            //this.getBonLivraisonsCompte(this.$route.params.id_compte);
