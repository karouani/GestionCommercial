      ...
      <form @submit.stop.prevent="handleSubmit">
         ...
         <select class="form-control custom-select " id="fk_compte" v-model="document" >
           ...
           <a href="#"    @click="PdfBonCommande(bonCommande.reference_bc)"  class="btn btn-secondary mb-3  float-right" ><i class="far fa-file-pdf"> Imprimer</i></a>
              ...
              <router-link class="btn btn-primary mb-3 retour float-right " :to="'/ShowBonCommandes'">
...
<div class="row">
    <div class="col">
        <br>
    <h5><i class="far fa-file"></i> Information sur la Commande : <strong>{{bonCommande.reference_bc}}</strong></h5>
    </div>
</div>
<hr>
<div class="row">
            ...
            <label>E-mail :{{bonCommande.email}}</label>
               ...
               <div class="form-group row">
                ...
                <select class="form-control custom-select " id="fk_status_d"  v-model="bonCommande.fk_status_bc" @change="getStatu()">
                    <option value="Brouillon" disabled>Brouillon</option>
    ...
    updateStatusBC(){
                ...
                .then(response => {
                    ...
                    if(response.data.etat){
                        this.$router.push({ name: 'ShowBonCommandes', params: { success: "editStatusuccess"  }});
                    }
                })
                .catch(error => {
                })
